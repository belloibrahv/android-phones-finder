...
const DisclaimerText = () => {
  return (
    <Box sx={{ my: 6, mx: 15 }}>
      ...
      <Typography variant="body2" color="text.secondary" sx={{ mb: 2, fontFamily: '"", Roboto, Helvetical, sans-serif', }}>
      ...
      <Typography variant="body2" color="text.secondary" sx={{fontFamily: '"", Roboto, Helvetical, sans-serif' }}>
